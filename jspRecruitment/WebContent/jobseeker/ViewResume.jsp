			...
			<div class="resume_content_top_box">
				<div class="resume_content_left">
					...
					<span class="resume_content_msg_c" style="width: 140px;"> <span
						class="resume_content_msg_span">学历：</span><%=rs.getString(10) %>
					</span> <span class="resume_content_msg_c"> <span
						class="resume_content_msg_span">经验：</span><%=rs.getString(8) %>
						...
						class="resume_content_msg_span">所在地：</span><%=rs.getString(9) %>
			...
			<div class="resume_content_box">
				...
				<div class="resume_content_yx_cont">
					<div class="resume_content_yx_list resume_content_yx_list_w100">
						<span class="resume_c6">期望职位：</span><%=rs.getString(13) %>
						</div>
					<div class="resume_content_yx_list">
						<span class="resume_c6">期望行业：</span><%=rs.getString(6) %>
					</div>
					<div class="resume_content_yx_list">
						<span class="resume_c6">待遇要求：</span><%=rs.getString(17) %> <font color="#888888">RMB</font>
					</div>
					<div class="resume_content_yx_list">
						<span class="resume_c6">工作地区：</span><%=rs.getString(16) %>
					</div>
				</div>
				<div class="clear"></div>
				<div class="resume_list">
					...
					<div class="resume_content_yx_cont">
						<div class="resume_content_yx_list">
							<span class="resume_c6">电话号码：</span><%=rs.getString(11) %>
						</div>
						<div class="resume_content_yx_list">
							<span class="resume_c6">电子邮件：</span><%=rs.getString(12) %>
						</div>
					</div>
					<div class="clear"></div>
					<div class="resume_list">
						...
						<div class="resume_content_yx_cont">
							<div class="resume_content_yx_list resume_content_yx_list_w101">
								<span class="resume_c6">个人特长：</span><%=rs.getString(14) %>
							</div>
							<div class="resume_content_yx_list resume_content_yx_list_w101">
								<span class="resume_c6">自我介绍：</span><%=rs.getString(18) %>
							</div>
						</div>
					</div>
				</div>
