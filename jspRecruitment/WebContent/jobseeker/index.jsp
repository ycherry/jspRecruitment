...
<script src="../js/util/lazyload.min.js"></script>
<script src="../js/public.js"></script>
<script src="../js/reg_ajax.js" type="text/javascript"></script>
<script src="../js/index.js"></script>
<script src="../js/search.js"></script>
<script src="../js/util/slides.jquery.js"></script>
<style type="text/css">
body {
	padding: 0px;
	margin: 0px;
...
<body class="index_body_box">
	...
	<div id="container">
		...
		<div id="main">
			<iframe src="SearchJob.jsp" name="mainFrame" id="iframe-main"></iframe>
		</div>
	...
	<!-- footer start -->
	<div class="row">
		<dl class="col-sm-offset-2 col-sm-3 login_list">
			<dt>
