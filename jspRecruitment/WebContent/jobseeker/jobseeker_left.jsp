...
<body LINK=firebrick VLINK=#660000 ALINK=red>
	<div class="sidebar-menu">
		...
		<ul id="userMeun" class="nav nav-list collapse menu-second">
			...
			<li><a href="ViewResume.jsp?resumeId=<%=resumeId %>" target="mainFrame"><i class=""></i>&nbsp;&nbsp;预览简历信息</a></li>
		...
		<ul id="recruitmentMenu" class="nav nav-list collapse menu-second">
			...
			<li><a href="editJobSelect.jsp" target="mainFrame"><i
					class="icon-list-alt"></i> 编辑招聘信息</a></li>
		</ul>
		...
		<ul id="resumeMenu" class="nav nav-list collapse menu-second">
			<li><a href="search.jsp" target="mainFrame"><i
					class="icon-pencil"></i> 简历搜索</a></li>
			<li><a href="findJob.jsp" target="mainFrame"><i
					class="icon-list-alt"></i> 浏览全部求职者信息</a></li>
		</ul>
		...
		<ul id="mailMenu" class="nav nav-list collapse menu-second">
			<li><a href="../mail/index.jsp" target="mainFrame"><i
					class="icon-pencil"></i> 发送邮件</a></li>
		</ul>
		...
		<ul id="otherMenu" class="nav nav-list collapse menu-second">
			<li><a href="../logout.jsp" target="_parent"><i
