	...
	if (document.all) {
		...
		if (window.netscape) {
			try {
				...
				layer
						.alert(
								'���������δ����[��Ϊ��ҳ]���ܣ��������������ڵ�ַ��������about:config,Ȼ���� signed.applets.codebase_principal_support ֵ��Ϊtrue���ɣ�',
								2, 8);
				return false;
			}
		}
