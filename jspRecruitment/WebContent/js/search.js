...
function index_job(job_class){
	...
	if(html.replace(" ","")==''){
		...
		var selhtml="";
		html='<div class="student_tips" style="left: 120px;"></div><div class="sPopupTitle290"><h1 class="student_tips_h1"><span>��ѡ��</span></h1><div class="dialog-content"><ul class="selected clearfix">{selall}</ul></div><div class="tips_ture"><a href="javascript:determine();"  class="tips_sub1">ȷ��</a><a href="javascript:closelayer();" class="tips_sub2">ȡ��</a></div></div><div class="clear"></div><div class="sPopupBlock"><table id="jobTab" width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>';
				...
				if(typeof(jt[jobclassid1])=='object'){
					 for(var j=0;j<jt[jobclassid1].length;j++){
						...
						if(job_class_append.indexOf(','+jobclassid2+',')>=0){
							selhtml +='<li class="all'+jobclassid2+'"><a class="clean g3 selall" href="javascript:void(0);" data-val="'+jobclassid2+'+'+jn[jobclassid2]+'"><span class="text">'+jn[jobclassid2]+'</span><span class="delete" data-id="'+jobclassid2+'">�Ƴ�</span></a></li>';
							disabled = "disabled";
							allchecked = "checked";
						}
						if(typeof(jt[jobclassid2])=='object'){
							...
							for(var k=0;k<jt[jobclassid2].length;k++){
								...
								if(job_class_append.indexOf(','+jobclassid3+',')>=0){
									selhtml +='<li class="job_class_'+jobclassid3+' parent_'+jobclassid2+'"><a class="clean g3 selall" href="javascript:void(0);" data-val="'+jobclassid3+'+'+jn[jobclassid3]+'"><span class="text">'+jn[jobclassid3]+'</span><span class="delete" data-id="'+jobclassid3+'" data-pid ="'+jobclassid2+'">�Ƴ�</span></a></li>';
									if(allchecked==''){
										checked = "checked";
									}
								}
